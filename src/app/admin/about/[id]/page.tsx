    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="space-y-6 lg:col-span-2">
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Content ({activeLocale.toUpperCase()})</CardTitle>
            </CardHeader>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2 rounded-lg border-2 border-slate-300/40 bg-slate-50 p-3 dark:border-slate-700 dark:bg-slate-950/20">
                ...
                <p className="text-xs text-muted-foreground">Use a darker grey for richer body text contrast on the About Us page.</p>
              </div>
              <div className="space-y-2">
