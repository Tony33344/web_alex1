          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              <div className="space-y-2">
                ...
                <Input id="name_it" name="name_it" defaultValue={program.name_it || ''} />
              </div>
              <div className="space-y-2">
                <Label htmlFor="name_fr">Name (French)</Label>
                <Input id="name_fr" name="name_fr" defaultValue={program.name_fr || ''} />
              </div>
              <div className="space-y-2">
                <Label htmlFor="name_hi">Name (Hindi)</Label>
                <Input id="name_hi" name="name_hi" defaultValue={program.name_hi || ''} />
              </div>
              <div className="space-y-2">
                <Label htmlFor="name_si">Name (Slovenian)</Label>
                <Input id="name_si" name="name_si" defaultValue={program.name_si || ''} />
              </div>
            </div>
            <div className="space-y-2">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2">
                ...
                <Textarea id="description_de" name="description_de" rows={4} defaultValue={program.description_de || ''} />
              </div>
              <div className="space-y-2">
                <Label htmlFor="description_it">Description (Italian)</Label>
                <Textarea id="description_it" name="description_it" rows={4} defaultValue={program.description_it || ''} />
              </div>
              <div className="space-y-2">
                <Label htmlFor="description_fr">Description (French)</Label>
                <Textarea id="description_fr" name="description_fr" rows={4} defaultValue={program.description_fr || ''} />
              </div>
              <div className="space-y-2">
                <Label htmlFor="description_hi">Description (Hindi)</Label>
                <Textarea id="description_hi" name="description_hi" rows={4} defaultValue={program.description_hi || ''} />
              </div>
              <div className="space-y-2">
                <Label htmlFor="description_si">Description (Slovenian)</Label>
                <Textarea id="description_si" name="description_si" rows={4} defaultValue={program.description_si || ''} />
              </div>
            </div>
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2">
