          ...
          {page?.hero_image_url ? (
            <div className="relative aspect-[21/9]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-10">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="text-sm font-medium text-white/80 uppercase tracking-wider">Our Vision</span>
                </div>
            ...
            <div className="bg-gradient-to-br from-secondary/10 via-secondary/5 to-primary/10 p-8 sm:p-12 lg:p-16">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-sm font-medium text-muted-foreground uppercase tracking-wider">Our Vision</span>
              </div>
