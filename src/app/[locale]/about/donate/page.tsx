...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const title = page ? (getLocalizedField(page, 'title', locale) || page.title_en) : t('donate.title');
          ...
          {page?.hero_image_url ? (
            <div className="relative aspect-[21/9]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-10">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="text-sm font-medium text-white/80 uppercase tracking-wider">{t('donate.title')}</span>
                </div>
            ...
            <div className="bg-gradient-to-br from-rose-50 via-primary/5 to-secondary/10 dark:from-rose-950/20 dark:via-primary/5 dark:to-secondary/10 p-8 sm:p-12 lg:p-16">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-sm font-medium text-muted-foreground uppercase tracking-wider">{t('donate.title')}</span>
              </div>
        ...
        {content ? (
            ...
            <div className="space-y-4">
              <Card className="border-rose-200/50 bg-rose-50/50 dark:border-rose-900/30 dark:bg-rose-950/20">
                <CardContent className="pt-6 space-y-4">
                  <h3 className="font-semibold">{t('donate.getInvolved')}</h3>
                  <Link
                  ...
                  >
                    <span>{t('donate.volunteerWithUs')}</span>
          ...
          <Card className="border-dashed">
            <CardContent className="py-16 text-center">
              ...
              <p className="text-muted-foreground">{t('donate.contentComingSoon')}</p>
            </CardContent>
          </Card>
        )}
